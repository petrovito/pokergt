...
import game.DealingPlay;
import game.Game;
import game.GamePlay;

public class TestGame {
	
	public static Game test_game = new Game(TestDealer.test_dealer,TestBidSystem.test_bids);
	...
	public static void main(String[] args) {
		...
		seq.add(Bid.CALL(1));
		test_game_play.add(new DealingPlay(new Dealing(TestDealer.test_dealer,5,8), seq));
